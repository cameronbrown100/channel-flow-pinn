...
@modulus.sym.main(config_path="conf", config_name="config_target")
def run(cfg: ModulusConfig) -> None:
    ...
    rec3 = Rectangle(
        ...
        (2*chip_pos + 3*chip_width, chip_height+channel_width/4),
    )
    rec4 = Rectangle(
    ...
    # add validation data
    file_path = "comsol/comsol_channel_flow_target.csv"
